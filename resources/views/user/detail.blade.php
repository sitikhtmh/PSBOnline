    ...
    <body>
        @section('content')
                    <div class="">
                        ...
                        <div>
                            <a href="{{ url('/user/print') }}" class="btn btn-primary mt-4" target="_blank">Download PDF</a></div>
                        </div>
                    </div>
                        <div class="container">
                        <div class = "row">
                        <div class="col-10">
                        <h1 class="mt-10" style="text-align:center"> Data Diri</h1>
                        <br>
                    ...
                    <form style="width:100%;" action="" method="get" enctype="multipart/form-data">
                        ...
                        @csrf
                            ...
                            <!-- <input type="hidden" class="form-control" id="id_siswa" value="" name="id_siswa" readonly> -->
